...
- **x86_64 support** - Fast, optimized binaries and containers
...
Binaries (x86_64) are automatically built and attached to GitHub releases. Checksums included for verification.
